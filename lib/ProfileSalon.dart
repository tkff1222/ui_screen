...
class ProfileSalon extends StatefulWidget {
  ProfileSalon({Key key}) : super(key: key);

  @override
  _ProfileSalonState createState() => new _ProfileSalonState();
}
...
class _ProfileSalonState extends State<ProfileSalon>
        ...
        children: <Widget>[
              ...
              children: <Widget>[
                ...
                new Row(
                  children: <Widget>[
                    ...
                    _buildRatingPrice(),
                    new Text( " 700sq.feet ", style: TextStyle(
                      fontSize: 14,
                      fontWeight: FontWeight.w500,
                      fontFamily: "Montserrat",
                      color: Color(0xFF4A4A4A),
          ...
          new TabBar(
            indicator: new UnderlineTabIndicator(
                borderSide:
                BorderSide(width: 2.0, color: Colors.orange), //Color(0xFFFF7B6E)
                insets: EdgeInsets.only(bottom: 10.0, right: 16.0)),
            indicatorColor: Colors.orange, //Color(0xFFFF7B6E),
            indicatorSize: TabBarIndicatorSize.label,
            isScrollable: false,
            labelColor: Colors.orange, //Color(0xFFFF7B6E),
            unselectedLabelColor: Color(0xFF4A4A4A), //Color(0xFF111111),
  ...
  _buildRatingPrice() {
    return new Row(
      children: <Widget>[
        new Icon(Icons.attach_money, color: Colors.black,size: 15,),
        new Icon(Icons.attach_money, color: Colors.black,size: 15,),
        new Icon(Icons.attach_money, color: Colors.black,size: 15,),
